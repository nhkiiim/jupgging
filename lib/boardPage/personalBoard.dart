                  ...
                  children: [
                    ...
                    Container(
                      ...
                      children: [
                        Padding(
                            padding: EdgeInsets.fromLTRB(
                                screenWidth * 0.1, screenHeight * 0.02, 0, 0),
                            child: Text("Running",
                                style: TextStyle(
                    ...
                    Container(
                      ...
                      children: [
                        Padding(
                            padding: EdgeInsets.fromLTRB(
                                screenWidth * 0.13, screenHeight * 0.02, 0, 0),
                            child: Text("Time",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: Colors.white))),
                        Padding(
                            padding: EdgeInsets.fromLTRB(
                                screenWidth * 0.12, screenHeight * 0.03, 0, 0),
                            child: Text(
                                "${totalHour.toString().padLeft(2, '0')}:${totalMinute.toString().padLeft(2, '0')}:${totalSec.toString().padLeft(2, '0')}",
                                style: TextStyle(color: Colors.white))),
                      ],
                    )),
                  ],
